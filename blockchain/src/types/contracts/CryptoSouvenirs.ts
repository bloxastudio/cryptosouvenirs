...
export interface CryptoSouvenirsInterface extends utils.Interface {
  functions: {
...
export interface CryptoSouvenirs extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CryptoSouvenirsInterface;
